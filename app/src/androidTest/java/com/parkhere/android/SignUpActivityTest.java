...
public class SignUpActivityTest {
    ...
    @Test
    public void SignUpActivityTest_email_null() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textinput_error), withText("Enter a valid email."),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.signup_input_layout_email),
                                        1),
                                0),
                        isDisplayed()));
    ...
    @Test
    public void SignUpActivityTest_email_neg() {
        // Added a sleep statement to match the app's execution delay.
        // The recommended way to handle such scenarios is to use Espresso idling resources:
        // https://google.github.io/android-testing-support-library/docs/espresso/idling-resource/index.html
        try {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.signup_input_email),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.signup_input_layout_email),
                                        0),
    ...
    @Test
    public void SignUpActivityTest_email_pos_pass_null() {
        // Added a sleep statement to match the app's execution delay.
        // The recommended way to handle such scenarios is to use Espresso idling resources:
        // https://google.github.io/android-testing-support-library/docs/espresso/idling-resource/index.html
        try {
        ...
        ViewInteraction textView1 = onView(
                allOf(withId(R.id.textinput_error), withText("Enter a valid password with min 6 characters."),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.signup_input_layout_password),
                                        1),
                                0),
                        isDisplayed()));
    ...
    @Test
    public void SignUpActivityTest_email_pos_pass_neg() {
        // Added a sleep statement to match the app's execution delay.
        // The recommended way to handle such scenarios is to use Espresso idling resources:
        // https://google.github.io/android-testing-support-library/docs/espresso/idling-resource/index.html
        try {
        ...
        ViewInteraction appCompatEditText9 = onView(
                allOf(withId(R.id.signup_input_password),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.signup_input_layout_password),
                                        0),
    ...
    @Test
    public void SignUpActivityTest_email_pos_pass_pos() {
        try {
            Thread.sleep(1500);
        } catch (InterruptedException e) {
            e.printStackTrace();
